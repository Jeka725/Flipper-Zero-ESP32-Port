...
static bool animation_manager_check_blocking(AnimationManager* animation_manager) {
    ...
    /*
     * ESP32-S3 ST7735S has no physical SD card. EXT storage is backed by
     * internal LittleFS and reports FSE_OK as the virtual SD status.
     * Skip the original physical-SD blocking sequence so L0_SdOk/L0_NoDb/
     * L0_Url cannot suppress normal idle animations.
     */
